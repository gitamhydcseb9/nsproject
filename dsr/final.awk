...
print "$ns at 22.4" "\t" "\"$init"0a4[0]"\t" "stop\"" > "cmsimu"1".tr"

print "set init"   a4[0]15 "\t""[attach-CBR-traffic $n("a1[ii]") $sink("14")]" > "cmsimu"1".tr"
print "$ns at 22.5" "\t" "\"$init"a4[0]15"\t" " start\"" > "cmsimu"1".tr"
print "$ns at 22.7" "\t" "\"$init"a4[0]15"\t" "stop\"" > "cmsimu"1".tr"
}
